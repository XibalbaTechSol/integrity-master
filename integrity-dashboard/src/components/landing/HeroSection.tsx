...
export const HeroSection = ({ setContactType, setIsContactOpen, setIsRegistryOpen }: { setContactType?: (v: 'investor' | 'developer') => void; setIsContactOpen?: (v: boolean) => void; setIsRegistryOpen: (v: boolean) => void }) => {
