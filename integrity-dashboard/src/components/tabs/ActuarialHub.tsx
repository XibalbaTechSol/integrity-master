    ...
    return (
      <div className="flex-col gap-6">
        ...
        <Panel 
          ...
          action={
            <button className="btn btn-icon" onClick={fetchTasks} disabled={loadingTasks} aria-label="Refresh live tasks">
  ...
  return (
    <div className="flex-col gap-6">
      <Panel 
        ...
        action={
          <button className="btn btn-icon" onClick={fetchBenchmarks} disabled={loadingBenchmarks} aria-label="Refresh network benchmarks">
