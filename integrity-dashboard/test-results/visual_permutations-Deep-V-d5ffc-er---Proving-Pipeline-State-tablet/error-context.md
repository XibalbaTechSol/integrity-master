...
- Name: visual_permutations.spec.ts >> Deep Visual Audit - Component Permutations >> ZKProver - Proving Pipeline State
- Location: e2e/visual_permutations.spec.ts:73:3
...
- button "ZK Prover"
- main:
  - text: Generate ZK Proof Subject Agent Hermes_Xibalba_Sovereign (0x67ba5d...) Proof Type
  - combobox "Proof Type":
    - option "AIS Score Above Threshold" [selected]
    - option "Historical Accuracy Valid"
    - option "Owns Specific Contract"
  - button "Generate Proof"
  - text: Verification Result Generate a proof to view results.
```
