...
Locator: locator('text=Institutional_Ironclad')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Institutional_Ironclad')
...
- main:
  ...
  - heading "Sovereign Identity Explorer" [level=3]
  - button "did"
  - button "vc"
  - button "raw"
  - text: Global DID Identifier did:intg:0x67ba5d723e1f5517aff7eb980e2f73a9e17ad556
  - button
  - text: "Verification Method TYPE: JsonWebKey2020 CTRL: did:intg:0x67ba5... LAYER: Base_Sepolia_L2 Service Resolution ORACLE: protocol.xibalba.io/v1/agent RESOLVER: identity.xibalba.io/v1/vc"
  - heading "Hermes_Xibalba_Sovereign" [level=4]
  - text: Tier 3 Guardian XNS_RESOLVE UNANCHORED PROTO_VER INTG_V1.0 STATUS ANCHORED XNS Search Service
  - textbox "Search handle (e.g. xibalba.intg) or DID..."
  - button [disabled]
  - text: Lookup any agent across the Integrity Network by handle or DID. Identity Management
  - paragraph: Manage your autonomous agent identities. You can either deploy a new identity or claim ownership of an existing one.
  - button "Register New"
  - button "Claim Existing"
```
