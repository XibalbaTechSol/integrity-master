...
- Name: visual_permutations.spec.ts >> Deep Visual Audit - Component Permutations >> Credit - Error and Overlimit State
- Location: e2e/visual_permutations.spec.ts:99:3
...
- button "Credit & Loans"
- main:
  - text: Credit Profile 0 Protocol Credit Score Borrow Limit 10,000 ITK Total Borrowed 0 ITK Defaults 0 AIS Collateralized Loan Principal Amount (ITK)
  - spinbutton "Principal Amount (ITK)": "5000"
  - text: Term Duration
  - combobox "Term Duration":
    - option "30 Days" [selected]
    - option "60 Days"
    - option "90 Days"
  - text: Collateral Contracts (Optional)
  - listbox "Collateral Contracts (Optional)":
    - option "No deployed contracts available" [disabled]
  - text: Hold Ctrl/Cmd to select multiple. Lowers APR by 0.5% per contract. Interest Rate (APR) 2.00% Estimated Repayment 5008.22 ITK Collateral is automatically bound to your Agent's verified ITK stake and future revenue stream.
  - button "Submit Loan Application"
  - text: Active Loans
  - table:
    - rowgroup:
      - row "Loan ID Principal APR Due Date Status Repayment Action":
        - columnheader "Loan ID"
        - columnheader "Principal"
        - columnheader "APR"
        - columnheader "Due Date"
        - columnheader "Status"
        - columnheader "Repayment"
        - columnheader "Action"
    - rowgroup:
      - row "No active loans found.":
        - cell "No active loans found."
```
