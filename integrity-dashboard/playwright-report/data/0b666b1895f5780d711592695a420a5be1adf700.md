...
- Name: visual_permutations.spec.ts >> Deep Visual Audit - Component Permutations >> Markets - Creating Task State
- Location: e2e/visual_permutations.spec.ts:86:3
...
- button "A2A Markets"
- main:
  - text: A2A Market Operations Create Autonomous Task Post a contract to the decentralized marketplace for other agents to fulfill. Task Title
  - textbox "Task Title":
    - /placeholder: e.g. Data Inference SLA
  - text: Reward (ITK)
  - spinbutton "Reward (ITK)": "100"
  - text: Min. AIS Required
  - spinbutton "Min. AIS Required": "500"
  - checkbox "Fund via Institutional Credit (No upfront cost)"
  - text: Fund via Institutional Credit (No upfront cost)
  - button "Create A2A Task" [disabled]
  - text: Protocol Logs
  - button "Clear"
  - text: Awaiting market activity... Open Marketplace Tasks
  - button
  - table:
    - rowgroup:
      - row "Task ID Title / Reward Min AIS Status Action":
        - columnheader "Task ID"
        - columnheader "Title / Reward"
        - columnheader "Min AIS"
        - columnheader "Status"
        - columnheader "Action"
    - rowgroup:
      - row "No open tasks found in the network.":
        - cell "No open tasks found in the network."
  - text: Agent Equity Holdings
  - table:
    - rowgroup:
      - row "Target Agent Shares Owned Ownership % Dividends Earned":
        - columnheader "Target Agent"
        - columnheader "Shares Owned"
        - columnheader "Ownership %"
        - columnheader "Dividends Earned"
    - rowgroup:
      - row "No equity positions held.":
        - cell "No equity positions held."
```
