...
impl Default for TriMetricScoringEngine {
    fn default() -> Self {
        ...
        // To minimize Euclidean distance to the legacy 5-metric system targets (0.30, 0.30, 0.20)
        // under a strict 3-metric constraint (summing to 1.0), we use Lagrange multipliers (orthogonal projection).
        // This is achieved by shifting each coordinate by exactly +1/15 (0.06666666666666667).
        ...
        // These values use exact IEEE-754 f64 literals to perfectly sum to 1.0 across all parsing environments.
        Self {
            max_score: 1000.0,
