...
impl Default for TriMetricScoringEngine {
    fn default() -> Self {
        ...
        // The optimal weights are derived using Lagrange multipliers (orthogonal projection) to strictly
        // minimize Euclidean distance to the legacy 5-metric system targets (0.30, 0.30, 0.20) under
        // a strict 3-metric constraint (summing to 1.0). Each coordinate is shifted by exactly +1/15.
