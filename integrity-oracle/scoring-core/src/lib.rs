...
impl Default for TriMetricScoringEngine {
    fn default() -> Self {
        Self {
            max_score: 1000.0,
            // The optimal weights are derived using Lagrange multipliers to strictly minimize
            // Euclidean distance to the legacy 5-metric system targets (0.30, 0.30, 0.20)
            // under a strict 3-metric constraint where the sum equals 1.0.
