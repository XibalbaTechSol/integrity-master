...
## 4. Xibalba Shield (ERC-4337)

### Execute Arbitrary Contract (Premium)
Executes a generic smart contract call on Base L2 using gasless USDC-denominated billing. **Exclusive to Xibalba Shield Clients.**

**Endpoint:** `POST /shield/execute`

**Authentication:** Required (Shield Master Key)
