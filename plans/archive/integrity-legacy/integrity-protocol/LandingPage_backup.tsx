...
import { Mail, Code, Shield, ExternalLink, Activity, Zap, Target, Database, FileCheck, Fingerprint, Globe, Key, Search, ArrowRight, Copy, Github, Cpu, Building2, ShieldCheck, Lock, Coins } from 'lucide-react';
    ...
    return (
        <div style={{ background: 'var(--navy-deep)', color: 'white', minHeight: '100vh', overflowX: 'hidden' }}>
            ...
            <header style={{ 
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: '1400px', margin: '0 auto' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? '8px' : '16px' }}>
                        ...
                        />
                        <div>
                            <div style={{ fontSize: isMobile ? '0.8rem' : '1.1rem', fontWeight: 800, letterSpacing: '0.15em' }}>INTEGRITY <span style={{ color: 'var(--gold)', fontWeight: 400 }}>v8.0</span></div>
                    ...
                    >
                        ...
                        <p style={{ fontSize: isMobile ? '0.85rem' : '1rem', color: 'rgba(255,255,255,0.4)', maxWidth: '850px', margin: '0 auto 48px', lineHeight: 1.8, padding: isMobile ? '0 10px' : '0' }}>
                            {isMobile ? 
                                ...
                                "In an economy managed by autonomous agents, trust is the scarcest resource. Our protocol provides the definitive Tri-Metric assessment layer—anchored on Base L2—to verify machine reliability, grounding, and commercial accountability at scale."
                            }
                        </p>
                        ...
                        >
                            <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'center', gap: isMobile ? '16px' : '20px' }}>
                                ...
                                <a 
                                    href="https://github.com/XibalbaTechSol/integrity-protocol/blob/main/docs/w3c_did.md" 
                                    target="_blank" 
                                ...
                                >
                                    TECHNICAL DOCS <ExternalLink size={14} />
                                </a>
                            </div>
                        </motion.div>
                    </motion.div>
            ...
            <footer style={{ padding: '80px 60px', borderTop: '1px solid rgba(255,255,255,0.05)', textAlign: 'center' }}>
                ...
                />
                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: isMobile ? '20px' : '48px', marginBottom: '48px', padding: isMobile ? '0 20px' : '0' }}>
                    {[
                        ...
                        <a 
                            ...
                            style={{ fontSize: isMobile ? '0.7rem' : '0.75rem', color: 'rgba(255,255,255,0.4)', textDecoration: 'none', fontWeight: 600, transition: 'color 0.2s', cursor: 'pointer', whiteSpace: 'nowrap' }}
                ...
                <p style={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.2)', fontWeight: 500 }}>
                    © 2026 Xibalba Technology Solutions. Integrity Protocol v8.0 is a sovereign reputation infrastructure.
                </p>
            </footer>
