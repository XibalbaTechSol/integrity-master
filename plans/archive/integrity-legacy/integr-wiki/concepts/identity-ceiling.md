...
To accommodate both anonymous independent agents and fully compliant institutional agents, the Integrity Project enforces a strict ceiling framework. While healthcare represents our first vertical, this ladder secures the broader infrastructure for the autonomous agent economy powered by smart contracts.

### Tier 0: Testing (Score Cap: 300)
*   **Verification Level:** None. For testing, agents use Developer API Keys generated via the dashboard. 
*   **Identity Ceiling:** Hard-capped at a maximum [ais](ais.md) of 300.
*   **Permissions:** These bypass strict hardware DID validation and are intended solely for development, testing, and sandbox environments.
